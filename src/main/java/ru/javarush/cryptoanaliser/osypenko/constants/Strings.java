...
public class Strings {
    public static final String HELLO = "Какую функцию Вы хотите выполнить?";
    public static final String FUNCTION1 = "1. Шифровка текста";
    public static final String FUNCTION2 = "2. Расшифровка текста с помощью ключа";
    public static final String FUNCTION3 = "3. Расшифровка текста с помощью brute force (перебор всех вариантов)";
